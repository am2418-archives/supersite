...
var htmlData = "
<button onclick='bringItBack(); window.close();'>#BringItBack</button><br/>
<button onclick='consoleType(); window.close();'>JS Console</button><br/>
<button onclick='gmailMoji(); window.close();'>gmail -> emojis</button><br/>
